...
<div class="card">
    <div class="card-header">
        <div class="row mb-2">
            <div class="col-sm-8">
                <h3 class="card-title"><b> ENTRY DATA SEKRETARIS</b></h3>
            </div>
        </div>
    </div>
    ...
    <div class="card-body">
        {{-- <div class="row"> --}}
        <form class="form-horizontal" action="/simpansekrebaru" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <label class="col-sm col-form-label">NAMA SEKRETARIS</label>
                            <div class="col-sm">
