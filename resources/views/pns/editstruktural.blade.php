...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <h3 class="card-title">Edit Diklat Struktural:</h3>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <form class="form-horizontal" action="/simpaneditstruktural/{{ $pegawai->id }}/{{ $struktural->id }}"
                ...
                <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="penyelenggara" class="form-control"
                                        style="text-transform: uppercase" value="{{ $struktural->penyelenggara }}">
                                </div>
                            </div>
                        </div>
                                ...
                                <DIV class="col-sm-10">
                                    <div class="input-group date" id="reservationdate4" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input"
                                            ...
                                            value="{{ $struktural->tgl_m->format('d-m-Y') }}" />
                                ...
                                <DIV class="col-sm-10">
                                    <div class="input-group date" id="reservationdate5" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input"
                                            ...
                                            value="{{ $struktural->tgl_s->format('d-m-Y') }}" />
                    ...
                    <table>
                        <tr style="color: rgb(252, 92, 0); font-size:16pt">
                            ...
                            <th style="text-align: left">
                                @if ($struktural->arsip !== '')
                                    ...
                                    <label class="col-sm col-form-label" style="text-align: left"
                                        name="ijazah">{{ $struktural->arsip }}</label>
                                @else
                            ...
                            <th>
                                @if ($struktural->arsip !== '')
                                    <a href="{{ url('arsip/struktural/' . $struktural->arsip) }}" target="_blank"
