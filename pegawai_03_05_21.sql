...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Bulan Mei 2021 pada 07.46
...
--
-- Struktur dari tabel `arsip_pangkat_berkala`
--

CREATE TABLE `arsip_pangkat_berkala` (
  `id` int(11) NOT NULL,
  `pegawai_id` int(11) NOT NULL,
  `no_berkala` varchar(50) COLLATE utf8_bin NOT NULL,
  `arsip` varchar(255) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `dt_kadis` (`id`, `pegawai_id`, `created_at`, `updated_at`) VALUES
(6, 8, '2021-04-21 15:35:03', '2021-04-21 15:35:03');
...
--
-- Struktur dari tabel `dt_sekda`
--

CREATE TABLE `dt_sekda` (
  `id` int(11) NOT NULL,
...
--
-- Struktur dari tabel `dt_sekretaris`
--

CREATE TABLE `dt_sekretaris` (
  `id` int(11) NOT NULL,
  `pegawai_id` varchar(25) COLLATE utf8_bin NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL
...
(1, '2021_04_24_083641_create_arsip_gaji_berkala_table', 0),
(2, '2021_04_24_083641_create_arsip_pangkat_berkala_table', 0),
(3, '2021_04_24_083641_create_arsip_pegawai_table', 0),
(4, '2021_04_24_083641_create_diklat_struktural_table', 0),
(5, '2021_04_24_083641_create_dt_kadis_table', 0),
(6, '2021_04_24_083641_create_dt_keluarga_table', 0),
(7, '2021_04_24_083641_create_dt_sekda_table', 0),
(8, '2021_04_24_083641_create_dt_sekretaris_table', 0),
(9, '2021_04_24_083641_create_masakerja_table', 0),
(10, '2021_04_24_083641_create_master_gol_table', 0),
(11, '2021_04_24_083641_create_master_j_gaji_table', 0),
(12, '2021_04_24_083641_create_master_jabatan_table', 0),
(13, '2021_04_24_083641_create_master_pendidikan_table', 0),
(14, '2021_04_24_083641_create_master_peraturan_table', 0),
(15, '2021_04_24_083641_create_master_pns_table', 0),
(16, '2021_04_24_083641_create_master_teknis_table', 0),
(17, '2021_04_24_083641_create_meninggal_table', 0),
(18, '2021_04_24_083641_create_mutasi_table', 0),
(19, '2021_04_24_083641_create_pegawai_table', 0),
(20, '2021_04_24_083641_create_pensiun_table', 0),
(21, '2021_04_24_083641_create_riwayat_gol_table', 0),
(22, '2021_04_24_083641_create_riwayat_jab_table', 0),
(23, '2021_04_24_083641_create_tbl_gaji_berkala_table', 0),
(24, '2021_04_24_083641_create_tbl_pangkat_berkala_table', 0),
(25, '2021_04_24_083641_create_tbl_penghargaan_table', 0),
(26, '2021_04_24_083641_create_tbl_pensiun_table', 0),
(27, '2021_04_24_083641_create_tbl_prestasi_table', 0);
...
--
-- Struktur dari tabel `tbl_pangkat_berkala`
--

CREATE TABLE `tbl_pangkat_berkala` (
  `id` int(11) NOT NULL,
  `No` varchar(50) COLLATE utf8_bin NOT NULL,
  `pegawai_id` varchar(25) COLLATE utf8_bin NOT NULL,
  `tgl` date NOT NULL,
  `pangkat_lama` varchar(11) COLLATE utf8_bin NOT NULL,
  `pangkat_baru` varchar(11) COLLATE utf8_bin NOT NULL,
  `pejabat` varchar(150) COLLATE utf8_bin NOT NULL,
  `tgl_berlaku_L` date NOT NULL,
  `masa_L_tahun` varchar(5) COLLATE utf8_bin DEFAULT NULL,
  `masa_L_bulan` int(11) DEFAULT NULL,
...
--
-- Indeks untuk tabel `arsip_pangkat_berkala`
--
ALTER TABLE `arsip_pangkat_berkala`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pegawai_id` (`pegawai_id`);
...
--
-- Indeks untuk tabel `dt_sekda`
--
ALTER TABLE `dt_sekda`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `dt_sekretaris`
--
ALTER TABLE `dt_sekretaris`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`),
  ADD KEY `pegawai_id` (`pegawai_id`);
...
--
-- Indeks untuk tabel `tbl_pangkat_berkala`
--
ALTER TABLE `tbl_pangkat_berkala`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pegawai_id` (`pegawai_id`);
...
--
-- AUTO_INCREMENT untuk tabel `arsip_pangkat_berkala`
--
ALTER TABLE `arsip_pangkat_berkala`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `dt_sekda`
--
ALTER TABLE `dt_sekda`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `dt_sekretaris`
--
ALTER TABLE `dt_sekretaris`
...
--
-- AUTO_INCREMENT untuk tabel `tbl_pangkat_berkala`
--
ALTER TABLE `tbl_pangkat_berkala`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
